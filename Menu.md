...
4. 炒糖色和炒肉可同时进行，如果不同时，先炒糖色
    ...
    $$
    $$
    \text{少量油，八块左右冰糖，中火烧化(如担心烧糊可全程小火)，勤搅动}
    $$
    $$
    \text{如有大块冰糖，用锅铲敲碎}
    $$
    $$
    \text{烧化后为棕红色，随后颜色越来越深，逐渐变为枣红色，勤搅动}
    $$
    $$
    \text{改小火继续炒，出现小泡}
    $$
    $$
    \text{马上会出现大泡，此时迅速倒入半碗冷水降温，小心少量热水飞溅}
    $$
    $$
    \text{可继续收汁一会，亦可直接盛出}
    $$
    ...
    $$
    $$
    \text{锅烧热，少量油(带皮五花肉先小火，肉皮朝下炒一会煸掉水)}
    $$
    $$
    \text{中火，肉炒至黄色出现 (去水、定形)}
    $$
    $$
    \text{加入少量葱、姜、蒜炒香，加半勺盐炒一会}
    $$
5. 将糖色倒入肉锅中，加入热水至接近没过肉，加一勺盐，如不够甜可加一点糖
6. 高压锅上汽后压10-15min，普通锅小火煮45min以上
7. 挑出葱、姜、蒜，如喜欢吃蒜加入几瓣微微炒过的蒜，大火收汁
- 肉不要选一点肥肉都不带的
- 排骨不用焯水，除非特别不新鲜
- 炒糖色的红烧肉/排骨偏甜，且颜色较红
...
3. 搓圆，28-30°C 发酵至2倍大(约70min)，此时炒制番茄酱和备菜
    ...
    $$
    $$
    \text{一个去皮番茄、半瓣蒜和极少量洋葱切丁(番茄尽量切小)}
    $$
    $$
    \text{蒜、洋葱炒一会炒出香味，加入番茄继续炒，用锅铲按压帮助炒烂(如果要焦了加一点点水继续炒)}
    $$
    $$
    \text{待番茄接近炒烂，加入一勺盐、一勺糖、一点胡椒粉，较多番茄酱，继续炒至完全炒烂}
    $$
    $$
    \text{备菜：}
    $$
    $$
    \text{一点点彩椒、很少洋葱切丝，一根香肠切片，拿出大量解冻好的马苏里拉芝士(提前至少3h解冻)}
    $$
4. 将面团铺在防粘烤盘或油纸上，中间薄四周厚，用叉子一排排捅上孔(此时可预先切好)
5. 面团涂上番茄酱，铺一层芝士，放上备的菜，铺一层芝士
6. 230°C 烤15min(前5分钟放蒸汽，可使面饼更松软)